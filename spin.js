...
var data = [
    ...
    {"label": "Weather App", "value": 4, "question": "Build a weather app that fetches data from an API.", "color": "blue"},
    {"label": "JavaScript Clock", "value": 5, "question": "Create a digital clock using JavaScript.", "color": "green"},
    {"label": "To-Do List", "value": 6, "question": "Make a simple to-do list with HTML, CSS, and JavaScript.", "color": "red"},
    {"label": "CSS Animations", "value": 7, "question": "Experiment with CSS animations and transitions.", "color": "gold"},
    {"label": "Markdown Previewer", "value": 8, "question": "Build a markdown previewer with JavaScript.", "color": "blue"},
    {"label": "Color Picker", "value": 9, "question": "Create a color picker tool using JavaScript and HTML.", "color": "green"},
    {"label": "Countdown Timer", "value": 10, "question": "Create a countdown timer for New Year’s using JavaScript.", "color": "red"},
    ...
    {"label": "CSS Grid Layout", "value": 12, "question": "Design a basic website layout using CSS Grid.", "color": "blue"},
    {"label": "Image Slider", "value": 13, "question": "Create an image slider with next and previous buttons using JavaScript.", "color": "green"},
    {"label": "HTML Form", "value": 14, "question": "Build a responsive contact form using HTML and CSS.", "color": "red"},
    {"label": "Christmas Card", "value": 15, "question": "Create a digital Christmas card with HTML/CSS.", "color": "gold"},
    {"label": "Palindrome Checker", "value": 16, "question": "Check if a word is a palindrome with JavaScript.", "color": "blue"},
    {"label": "CSS Hover Effects", "value": 17, "question": "Experiment with various hover effects on buttons.", "color": "green"},
    {"label": "Python Temperature Converter", "value": 18, "question": "Convert temperatures between Celsius and Fahrenheit in Python.", "color": "red"},
    {"label": "JavaScript To-Do List", "value": 19, "question": "Create a simple to-do list app in JavaScript.", "color": "gold"},
    {"label": "Calculator in JavaScript", "value": 20, "question": "Build a basic calculator app using JavaScript.", "color": "blue"},
    {"label": "Python Rock, Paper, Scissors", "value": 21, "question": "Make a Rock, Paper, Scissors game in Python.", "color": "green"},
    {"label": "Markdown Previewer", "value": 22, "question": "Build a markdown previewer with JavaScript.", "color": "red"},
    {"label": "JavaScript Dice Roller", "value": 23, "question": "Create a dice roller that generates random numbers.", "color": "gold"},
    {"label": "Python Prime Number Checker", "value": 24, "question": "Check if a number is prime with Python.", "color": "blue"}
];
